 ...
 * @version 1.1.1
 * @description Chat creation date value object.
 */
export default class ChatCreationDate extends DateValueObject {
     ...
     */
     static current = () => new ChatCreationDate(DateValueObject.current());
}